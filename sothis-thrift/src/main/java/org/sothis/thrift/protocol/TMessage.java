...
public final class TMessage {
	private final static AtomicInteger SEQ_ID = new AtomicInteger(0);
	...
	public static TMessage newRequestMessage(String name) {
		return new TMessage(name, TMessageType.CALL, SEQ_ID.incrementAndGet());
	}

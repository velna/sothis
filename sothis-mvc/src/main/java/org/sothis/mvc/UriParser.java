...
public class UriParser {
	 ...
	 * specified charset.
	 */
	public UriParser(String uri, boolean hasPath) {
	 ...
	 * specified charset.
	 */
	public UriParser(String uri, Charset charset) {
	 ...
	 * specified charset.
	 */
	public UriParser(String uri, Charset charset, boolean hasPath) {
	 ...
	 * specified charset.
	 */
	public UriParser(String uri, Charset charset, boolean hasPath, int maxParams) {
		if (uri == null) {
	 ...
	 * specified charset.
	 */
	public UriParser(URI uri, Charset charset) {
	 ...
	 * specified charset.
	 */
	public UriParser(URI uri, Charset charset, int maxParams) {
		if (uri == null) {
			throw new NullPointerException("getUri");
		}
		if (charset == null) {
	...
	public String queryString() {
		if (null == queryString) {
			if (hasPath) {
				...
				queryString = uri.substring(pathLength + 1);
			} else {
				queryString = uri;
			}
		}

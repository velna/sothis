...
public class BasicConverter implements TypeConverter<Object> {
	...
	public void convertor(XmlConverter converter, Object object, Writer out, String alias, List<Attribute> attributes)
			throws IOException {
		if (object == null) {
			return;
		}
		...
		node.setNode(alias);
		node.setValue(StringEscapeUtils.escapeXml10(object.toString()));
